...
function manage_question_10 (value) {
    if ((phq9_score > 0 ) && q10_gone){
        question = document.createElement("small");  // create the node to hold question 10
        question.class="text";
...
function update_score(index, new_score){  //index is the number of the question, score it's score
    ...
    if (phq9_score == 0 ) explanation = str_score_analysis[0];
    else if (phq9_score <5) explanation = str_score_analysis[1];
    else if (phq9_score <10) explanation = str_score_analysis[2];
    else if (phq9_score <20) explanation = str_score_analysis[3];
